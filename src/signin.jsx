...
const handleSubmit = (e) => {
    e.preventDefault();
setUser({login:email,password:pass});
console.log(user);
}
...
<form onSubmit={handleSubmit} className="form_container">
  ...
  <div className="input_container">
    ...
    <input value={email} onChange={(e)=> setEmail(e.target.value)} placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" />
  </div>
  <div className="input_container">
  ...
  <span>Don't have an account ? <button className="button-a-tag" onClick={()=>props.onFormSwitch('signup')} > Register here</button></span>
