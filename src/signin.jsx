...
const handleSubmit = (e) => {
    e.preventDefault();
    setLogingIn({login:email,password:pass});
props.logingUser(logingIn)
}
...
<form onSubmit={handleSubmit} className="form_container">
  ...
  <div className="input_container">
    ...
    <input value={email} onChange={(e)=> setEmail(e.target.value)} placeholder="name@email.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" />
  </div>
  <div className="input_container">
    ...
    <input value={pass} onChange={(e)=> setPass(e.target.value)} placeholder="Password" title="Inpit title" name="input-name" type="password" className="input_field" id="password_field" />
  </div>
  ...
  <span>Não tem uma conta ? <button className="button-a-tag" onClick={()=>props.onFormSwitch('signup')} > Registre aqui</button></span>
