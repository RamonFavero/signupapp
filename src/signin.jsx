...
<form onSubmit={handleSubmit} className="form_container">
  ...
  <div className="input_container">
    ...
    <input value={email} onChange={(e)=> setEmail(e.target.value)} placeholder="name@email.com" name="input-name" type="text" className="input_field" id="email_field" />
  </div>
  <div className="input_container">
    ...
    <input value={pass} onChange={(e)=> setPass(e.target.value)} placeholder="Password" name="input-name" type="password" className="input_field" id="password_field" />
  </div>
